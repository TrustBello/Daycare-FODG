...
var de = (i, e, t) =>
    e in i
      ? Ee(i, e, { enumerable: !0, configurable: !0, writable: !0, value: t })
      : (i[e] = t),
  Y = (i, e) => {
    for (var t in e || (e = {})) Pe.call(e, t) && de(i, t, e[t]);
    if (oe) for (var t of oe(e)) Ie.call(e, t) && de(i, t, e[t]);
    return i;
  },
  X = (i, e) => Ce(i, Me(e));
function ce(i) {
  ...
  i === void 0 && (i = {}),
    ...
    Object.keys(e).forEach((t) => {
      typeof i[t] == "undefined"
        ? (i[t] = e[t])
        : ce(e[t]) && ce(i[t]) && Object.keys(e[t]).length > 0 && K(i[t], e[t]);
    });
}
const fe = {
  body: {},
        ...
        a !== void 0 &&
          ...
          (H(i[l]) && H(s[l])
            ? s[l].__swiper__
              ...
              : k(i[l], s[l])
            : !H(i[l]) && H(s[l])
            ? ((i[l] = {}), s[l].__swiper__ ? (i[l] = s[l]) : k(i[l], s[l]))
            : (i[l] = s[l]));
      }
    }
  }
...
function ue(i) {
  ...
  const u = t > r ? "next" : "prev",
    ...
    p = () => {
      ...
      let v = r + m * (t - r);
      if ((f(v, t) && (v = t), e.wrapperEl.scrollTo({ [s]: v }), f(v, t))) {
        ...
        ((r = new ResizeObserver((p) => {
          o = n.requestAnimationFrame(() => {
            ...
            let v = h,
              b = m;
            p.forEach((E) => {
              let { contentBoxSize: w, contentRect: c, target: d } = E;
              (d && d !== e.el) ||
                ((v = c ? c.width : (w[0] || w).inlineSize),
                (b = c ? c.height : (w[0] || w).blockSize));
            }),
              (v !== h || b !== m) && l();
          });
        })),
...
function qe() {
  ...
  for (let S = 0; S < p; S += 1) {
    ...
    if (
      (f[S] && (x = f[S]),
      A && i.grid.updateSlide(S, x, f),
      !(f[S] && V(x, "display") === "none"))
    ) {
      if (t.slidesPerView === "auto") {
        ...
        if (
          ...
          z = i.isHorizontal() ? J(x, "width", !0) : J(x, "height", !0);
        else {
          const I = e(C, "width"),
            O = e(C, "padding-left"),
          ...
          if (le && le === "border-box") z = I + ne + ae;
            ...
            const { clientWidth: xe, offsetWidth: ye } = x;
        ...
        (z = (r - (t.slidesPerView - 1) * d) / t.slidesPerView),
          t.roundLengths && (z = Math.floor(z)),
          f[S] && (f[S].style[i.getDirectionLabel("width")] = `${z}px`);
      f[S] && (f[S].swiperSlideSize = z),
        v.push(z),
        t.centeredSlides
          ? ((g = g + z / 2 + y / 2 + d),
            y === 0 && S !== 0 && (g = g - r / 2 - d),
  ...
  if (
    ...
    o &&
      ...
      (s.style.width = `${i.virtualSize + d}px`),
    t.setWrapperSize &&
      (s.style[i.getDirectionLabel("width")] = `${i.virtualSize + d}px`),
    A && i.grid.updateWrapperSize(z, h),
    !t.centeredSlides)
  ) {
    const S = [];
    for (let x = 0; x < h.length; x += 1) {
      ...
      t.roundLengths && (C = Math.floor(C)),
        h[x] <= i.virtualSize - r && S.push(C);
    }
    (h = S),
      Math.floor(i.virtualSize - r) - Math.floor(h[h.length - 1]) > 1 &&
        h.push(i.virtualSize - r);
  }
  if (a && t.loop) {
    const S = v[0] + d;
    ...
    for (let x = 0; x < i.virtual.slidesBefore + i.virtual.slidesAfter; x += 1)
      t.slidesPerGroup === 1 && h.push(h[h.length - 1] + S),
  ...
  if (
    ...
    const S = -i.snapGrid[0],
      x = -i.slidesGrid[0];
    (i.snapGrid = i.snapGrid.map((C) => C + S)),
      (i.slidesGrid = i.slidesGrid.map((C) => C + x));
  }
  if (
    ...
    m.length !== c && i.emit("slidesGridLengthChange"),
    ...
    p <= t.maxBackfaceHiddenSlides
      ? x || i.el.classList.add(S)
      : x && i.el.classList.remove(S);
  }
}
function Ye(i) {
  const e = this,
...
function Ke(i) {
  ...
  for (let a = 0; a < s.length; a += 1) {
    ...
    ((m >= 0 && m < e.size - 1) ||
      ...
      b && s[a].classList.add(t.slideFullyVisibleClass),
      (u.progress = n ? -p : p),
...
function Ze(i) {
  ...
  if ((typeof a == "undefined" && (a = Qe(e)), s.indexOf(t) >= 0))
    u = s.indexOf(t);
  else {
  ...
  if (
    ...
    if (e === 0) l[p ? "scrollLeft" : "scrollTop"] = -f;
      ...
      if (!r.support.smoothScroll)
        return (
          ue({ swiper: r, targetPosition: -f, side: p ? "left" : "top" }), !0
        );
...
function ut(i, e, t, s, n) {
  ...
  if (l.cssMode) {
    ...
    if (e === 0) {
      ...
      if (!r.support.smoothScroll)
        return (
          ue({ swiper: r, targetPosition: g, side: d ? "left" : "top" }), !0
        );
      m.scrollTo({ [d ? "left" : "top"]: g, behavior: "smooth" });
    }
    return !0;
  }
  return (
    ...
    (r = parseInt(i.clickedSlide.getAttribute("data-swiper-slide-index"), 10)),
      e.centeredSlides
        ? n < i.loopedSlides - s / 2 ||
          ...
          ? (i.loopFix(),
            (n = i.getSlideIndex(
              $(t, `${o}[data-swiper-slide-index="${r}"]`)[0]
            )),
            U(() => {
              i.slideTo(n);
            }))
...
function bt(i) {
  ...
  const S = c ? Math.ceil(u.length / m.grid.rows) : u.length,
    C =
      (c ? u[r].column : r) + (v && typeof n == "undefined" ? -b / 2 + 0.5 : 0);
  if (C < w) {
    z = Math.max(w - C, E);
  ...
  if (
    ...
    m.slidesPerView === "auto"
      ? a.updateSlides()
      : c &&
        ((d.length > 0 && A) || (g.length > 0 && M)) &&
        a.slides.forEach((T, P) => {
    ...
    if (d.length > 0 && A) {
      if (typeof e == "undefined") {
        ...
        l
          ? a.setTranslate(a.translate - I)
          : (a.slideTo(y + z, 0, !1, !0),
            n &&
              ((a.touchEventsData.startTranslate =
                a.touchEventsData.startTranslate - I),
              (a.touchEventsData.currentTranslate =
                a.touchEventsData.currentTranslate - I)));
      } else if (n) {
...
var yt = { loopCreate: Tt, loopFix: bt, loopDestroy: xt };
function Et(i) {
  const e = this;
  if (
...
function Lt(i) {
  ...
  if (a.type === "touchmove") {
    if (
      ((u = [...a.changedTouches].filter((M) => M.identifier === s.touchId)[0]),
  ...
  if (typeof s.isScrolling == "undefined") {
    ...
    (t.isVertical() && r.currentX === r.startX)
      ? (s.isScrolling = !1)
      : h * h + m * m >= 25 &&
        ((M = (Math.atan2(Math.abs(m), Math.abs(h)) * 180) / Math.PI),
  ...
  if (!s.isMoved) {
    if (
      (w && c && t.loopFix({ direction: t.swipeDirection }),
        ...
        s.currentTranslate > t.minTranslate() &&
          ...
          n.resistance &&
            (s.currentTranslate =
              t.minTranslate() -
              1 +
              (-t.minTranslate() + s.startTranslate + v) ** y)))
      : v < 0 &&
        (w &&
          c &&
          !d &&
        ...
        s.currentTranslate < t.maxTranslate() &&
          ...
          n.resistance &&
            (s.currentTranslate =
              t.maxTranslate() +
              1 -
              (t.maxTranslate() - s.startTranslate - v) ** y))),
...
function zt(i) {
  ...
  if (s.type === "touchend" || s.type === "touchcancel") {
    if (
      ((n = [...s.changedTouches].filter((g) => g.identifier === t.touchId)[0]),
  ...
  if (e.allowClick) {
    ...
    e.updateClickedSlide((g && g[0]) || s.target, g),
      e.emit("tap click", s),
      h < 300 &&
  ...
  for (
    let g = 0;
    g < u.length;
    g += g < o.slidesPerGroupSkip ? 1 : o.slidesPerGroup
  ) {
    const y = g < o.slidesPerGroupSkip - 1 ? 1 : o.slidesPerGroup;
    typeof u[g + y] != "undefined"
      ? m >= u[g] && m < u[g + y] && ((v = g), (b = u[g + y] - u[g]))
      : m >= u[g] && ((v = g), (b = u[u.length - 1] - u[u.length - 2]));
  }
  let E = null,
    w = null;
  o.rewind &&
  ...
  if (h > o.longSwipesMs) {
    ...
    e.swipeDirection === "next" &&
      (c >= o.longSwipesRatio
        ? e.slideTo(o.rewind && e.isEnd ? E : v + d)
        : e.slideTo(v)),
      e.swipeDirection === "prev" &&
        (c > 1 - o.longSwipesRatio
          ? e.slideTo(v + d)
          : w !== null && c < 0 && Math.abs(c) > o.longSwipesRatio
          ? e.slideTo(w)
          : e.slideTo(v));
  } else {
    if (!o.shortSwipes) {
    ...
    (s.target === e.navigation.nextEl || s.target === e.navigation.prevEl)
      ? s.target === e.navigation.nextEl
        ? e.slideTo(v + d)
        : e.slideTo(v)
      : (e.swipeDirection === "next" && e.slideTo(E !== null ? E : v + d),
        e.swipeDirection === "prev" && e.slideTo(w !== null ? w : v));
  }
}
function ve() {
  const i = this,
...
var Vt = { attachEvents: Dt, detachEvents: $t };
...
var Nt = { setBreakpoint: Bt, getBreakpoint: Ft };
function Ht(i, e) {
  const t = [];
  return (
    i.forEach((s) => {
...
class D {
  ...
  slidesPerViewDynamic(e, t) {
    ...
    if (n.centeredSlides) {
      ...
      for (let m = u + 1; m < r.length; m += 1)
        r[m] &&
          !h &&
          ((p += r[m].swiperSlideSize), (f += 1), p > a && (h = !0));
  ...
  mount(e) {
    ...
    return (
      !o &&
        ...
        ((o = W("div", t.params.wrapperClass)),
        s.append(o),
        $(s, `.${t.params.slideClass}`).forEach((l) => {
          o.append(l);
        })),
      Object.assign(t, {
        el: s,
  ...
  static use(e) {
    return Array.isArray(e)
      ? (e.forEach((t) => D.installModule(t)), D)
      : (D.installModule(e), D);
  }
}
  ...
  return (
    i.params.createElements &&
      Object.keys(s).forEach((n) => {
        if (!t[n] && t.auto === !0) {
          let r = $(i.el, `.${s[n]}`)[0];
          r || ((r = W("div", s[n])), (r.className = s[n]), i.el.append(r)),
            (t[n] = r),
            (e[n] = r);
        }
      }),
...
function Ut(i) {
  ...
  function f(c, d) {
    ...
    !c ||
      ((c = c[`${d === "prev" ? "previous" : "next"}ElementSibling`]),
      c &&
        (c.classList.add(`${g}-${d}`),
        (c = c[`${d === "prev" ? "previous" : "next"}ElementSibling`]),
        c && c.classList.add(`${g}-${d}-${d}`)));
  }
  function p(c) {
  ...
  function h() {
    ...
    if (
      (e.params.loop
        ...
        ? ((y = e.snapIndex), (M = e.previousSnapIndex))
        : ((M = e.previousIndex || 0), (y = e.activeIndex || 0)),
      d.type === "bullets" &&
      ...
      if (
        (d.dynamicBullets &&
          ((o = J(L[0], e.isHorizontal() ? "width" : "height", !0)),
          g.forEach((T) => {
          ...
          d.dynamicMainBullets > 1 &&
            ...
            l > d.dynamicMainBullets - 1
              ...
              : l < 0 && (l = 0)),
          (S = Math.max(y - l, 0)),
          (x = S + (Math.min(L.length, d.dynamicMainBullets) - 1)),
          (C = (x + S) / 2)),
        L.forEach((T) => {
          const P = [
            ...["", "-next", "-next-next", "-prev", "-prev-prev", "-main"].map(
              (I) => `${d.bulletActiveClass}${I}`
            ),
          ]
            .map((I) =>
              typeof I == "string" && I.includes(" ") ? I.split(" ") : I
            )
            .flat();
        ...
        L.forEach((T) => {
          const P = j(T);
          P === y
            ? T.classList.add(...d.bulletActiveClass.split(" "))
            : e.isElement && T.setAttribute("part", "bullet"),
            d.dynamicBullets &&
              (P >= S &&
                P <= x &&
                T.classList.add(...`${d.bulletActiveClass}-main`.split(" ")),
              P === S && f(T, "prev"),
              P === x && f(T, "next"));
        });
      else {
        const T = L[y];
        if (
          (T && T.classList.add(...d.bulletActiveClass.split(" ")),
          e.isElement &&
            L.forEach((P, I) => {
          ...
          for (let O = S; O <= x; O += 1)
            L[O] &&
              L[O].classList.add(...`${d.bulletActiveClass}-main`.split(" "));
          f(P, "prev"), f(I, "next");
        }
      }
      if (d.dynamicBullets) {
    ...
    g.forEach((L, S) => {
      if (
        (d.type === "fraction" &&
          (L.querySelectorAll(F(d.currentClass)).forEach((x) => {
        ...
        let T = 1,
          P = 1;
        x === "horizontal" ? (T = C) : (P = C),
          L.querySelectorAll(F(d.progressbarFillClass)).forEach((I) => {
            (I.style.transform = `translate3d(0,0,0) scaleX(${T}) scaleY(${P})`),
              (I.style.transitionDuration = `${e.params.speed}ms`);
          });
      }
      d.type === "custom" && d.renderCustom
        ? ((L.innerHTML = d.renderCustom(e, y + 1, z)),
          S === 0 && n("paginationRender", L))
        : (S === 0 && n("paginationRender", L), n("paginationUpdate", L)),
        e.params.watchOverflow &&
          e.enabled &&
          L.classList[e.isLocked ? "add" : "remove"](d.lockClass);
    });
  }
  function m() {
    ...
    if (c.type === "bullets") {
      ...
      for (let A = 0; A < M; A += 1)
        c.renderBullet
          ? (y += c.renderBullet.call(e, A, c.bulletClass))
          : (y += `<${c.bulletElement} ${
    ...
    c.type === "fraction" &&
      ...
      (e.pagination.bullets = []),
      g.forEach((M) => {
        c.type !== "custom" && (M.innerHTML = y || ""),
          c.type === "bullets" &&
            e.pagination.bullets.push(...M.querySelectorAll(F(c.bulletClass)));
      }),
      c.type !== "custom" && n("paginationRender", g[0]);
  }
  function v() {
    e.params.pagination = Xt(
      e,
    ...
    if (!c.el) return;
    let d;
    typeof c.el == "string" && e.isElement && (d = e.el.querySelector(c.el)),
      !d &&
        typeof c.el == "string" &&
        (d = [...document.querySelectorAll(c.el)]),
      d || (d = c.el),
      !(!d || d.length === 0) &&
        (e.params.uniqueNavElements &&
          ...
          Array.isArray(d) &&
          d.length > 1 &&
          ((d = [...e.el.querySelectorAll(c.el)]),
          d.length > 1 &&
            (d = d.filter((g) => pe(g, ".swiper")[0] === e.el)[0])),
  ...
  s("changeDirection", () => {
    ...
    s("click", (c, d) => {
      ...
      if (
        ...
        n(M === !0 ? "paginationShow" : "paginationHide"),
          y.forEach((A) => A.classList.toggle(e.params.pagination.hiddenClass));
      }
    });
  const E = () => {
